...
export default function WhatsAppButton({ productName, className = "" }: WhatsAppButtonProps) {
  ...
  return (
    <a 
      ...
      className={`inline-flex items-center justify-center gap-3 bg-[#25D366] text-white font-bold uppercase tracking-widest text-sm px-6 py-4 shadow-xl hover:scale-105 transition-transform ${className}`}
    >
